...
[Here](/3-11-WebBuild/index.html) is a WebBuild of the game. After the profile initialization, wait for a random event to pop up (shouldn't take too long). It does seem pretty barebones, but it feels like I accomplished a lot in terms of organizing information, organzing UI, and creating scripts that will be used throughout the game. Next week I plan to focus on how scoring will work in this the game and making the game look a bit better since it's very primitive right now. 
